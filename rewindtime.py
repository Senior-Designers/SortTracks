...
DIR_PIN_2 =  7 # Lower left motor direction pin
ENA_PIN_2 =  5# Lower left motor enable pin
...
def updateDisplay():
    ...
    if False:
        ...
        display_number(current_display)
    time.sleep(0.002) # Delay for checks
...
try:
    ...
    while True:
        ...
        if distance < 30.5: # Object detected within 1 foot, take picture
            ...
            time.sleep(1) # Wait 3 seconds before the next detection
